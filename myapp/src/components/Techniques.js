...
import imageman from "../images/photo_2024-05-04_14-31-56.jpg";
import "./Body.css";
  ...
  const callApi = async () => {
    try {
      const response = await axios.get(
        `https://mall.ahmadkouja.com/api/category/show?category_id=8&page=${count}`
      );
...
export default withAuth(Techniques);
